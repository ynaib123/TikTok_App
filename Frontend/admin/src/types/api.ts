...
import type { ServiceConnection, ServiceConnectionForm, ServiceProvider } from './services'
import type {
  TikTokAccount,
...
export interface WorkflowTriggerPayload {
  ...
  sceneTextStyles?: Array<Record<string, unknown>> | null
}
...
export interface VideoOpsApi {
  ...
  completeTikTokAuthorization: (params: {
    code: string
    state: string
  ...
  saveServiceConnection: (
    ...
    payload: SaveServiceConnectionPayload,
