...
import type { VideoOpsDashboard, VideoOpsHealth, VideoOpsObservability } from '../types'
...
export function useVideoDashboard(): UseVideoDashboardResult {
  ...
  const firstError = healthQuery.error || observabilityQuery.error || dashboardQuery.error
