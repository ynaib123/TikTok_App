...
-- See PHASE1_STABILITY.md for rationale.
...
CREATE INDEX IF NOT EXISTS idx_video_workflow_runs_idea_started
    ON video_workflow_runs (content_idea_id, started_at DESC);
...
CREATE INDEX IF NOT EXISTS idx_service_connections_provider_active
    ON service_connections (provider_key, active);
